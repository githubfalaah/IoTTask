#include <M5Stack.h>   // Library yang digunakan
#define ADC_ADDR 0x48  // Memberi definisi ADC
...
while(Wire.available()){       // Statement perintah/ kondisi
data_H = Wire.read();
data_L = Wire.read();
}
...
void setup() {         // Fungsi input output
M5.begin();
Wire.begin();
dacWrite(25, 0);
